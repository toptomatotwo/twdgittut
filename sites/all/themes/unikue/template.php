...
/*
function unikue_theme_preprocess_user_login_block(&$vars){
 ...
 * they are properly detected when drupal_alter() is invoked.
  */
unikue_include('unikue', 'theme/alter.inc');
unikue_include('unikue', 'theme/ultis.inc');

/*
function unikue_preprocess_node(&$vars){
	echo '<script>alert("huh?");</script>'; 
	kpr($vars);
} */  

function unikue_preprocess_block(&$vars){

  // Add unique id including block-my-subject
  $vars['block-block-1'] = drupal_html_id('hello');
